---
title: "(outdated) DeerStorage - a very fast self-hosted database with shareable rows/files"
date: 2021-05-16
...
![alt text](/deer/editing_tables.png "Editing tables...")
...
![alt text](/deer/lookup-a-dog.png "Finding pet...")
...
![alt text](/deer/sharing-record-for-viewing.png "Sharing a visit recommendations...")
...
![alt text](/deer/opendocument-format-preview.png "Preview in shared record...")
...
![alt text](/deer/creating-connected-record.png "Creating connected record...")

It's immediately connected to your dog record, so scroll down and click "Open" on it.

![alt text](/deer/opening-connected-record.png "Opening connected record...")

And share it enabling link receiver to edit and upload files. Copy the link to clipboard and send it to them.

![alt text](/deer/sharing-to-edit.png "Generate a share to edit link...")

They can upload files and insert their name, so you know exactly who send you the files.

![alt text](/deer/uploading-files-as-guest.png "Uploading files as a guest...")

After they upload the image, you will see it from your dog record:

![alt text](/deer/receiving-a-file-from-client.png "Receiving a file from a guest...")
...
![alt text](/deer/csv-importer.png "CSV Importer...")
...
![alt text](/deer/csv-importer-results.png "CSV Importer reports...")
...
![alt text](/deer/fuzzy-searching-records.png "Fuzzy searching records...")

You can upload files for each, share them if you want, compare them, etc.

![alt text](/deer/comparing-records.png "Comparing records...")
...
![alt text](/deer/overwrite-attempt.png "Attempting an overwrite record...")
...
![alt text](/deer/admin-panel.png "Viewing a user in admin panel...")

Similarly you can see all users connected to a database:

![alt text](/deer/admin-panel-list-subscription-users.png "Viewing a database in admin panel...")
...
![alt text](/deer/managing-users-as-regular-user.png "Managing users as regular user...")
...
![alt text](/deer/changing-database-limits.png "Editing database limits...")
...
![alt text](/deer/example-templates.png "Example database templates...")
